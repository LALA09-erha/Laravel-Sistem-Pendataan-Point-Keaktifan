                                    ...
                                    <div class="modal-body">
                                        <form action="/editdetailkeaktifan" method="post" style="width:100%">
                                            ...
                                            <div class="form-group has-icon-left" style="width: 100%">
                                                ...
                                                <label for="password-id-icon">Kedudukan Kegiatan</label>
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" name="kedudukan_kegiatan"
                                                    placeholder="kedudukan_kegiatan" id="password-id-icon" value="{{$mhs['kedudukan_kegiatan']}}" required readonly>
                                                    <div class="form-control-icon">
